...
export type ClassesQuery = { __typename?: 'Query', classes: Array<{ __typename?: 'Class', id: number, teacherId: number, name: string, createdAt: string, updatedAt: any, students: Array<{ __typename?: 'User', id: number, username: string, createdAt: string, updatedAt: string }>, tasks: Array<{ __typename?: 'Task', createdAt: string, updatedAt: any, title: string, priority: number, dueDate?: any | null }> }> };
