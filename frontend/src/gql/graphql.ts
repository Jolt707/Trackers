...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', id: number, userId: number, title: string, description: string, notes?: string | null, createdAt: string, dueDate?: any | null, priority: number, updatedAt: any, completedTask: boolean } };
...
export type TasksQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: number, title: string, description: string, notes?: string | null, createdAt: string, dueDate?: any | null, priority: number, updatedAt: any, completedTask: boolean }> };
